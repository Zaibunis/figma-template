  ...
  return (<section className="text-gray-600 body-font">
    <div className="container px-5 py-16 mx-auto">
      {loading ? (
        ...
        // On small screens, use 2 columns (2 per row),
        // and on large screens (lg breakpoint) switch to 4 columns (all in one row)
          ...
          {products.slice(0, 4).map((product: any) => (
            <div key={product._id} className="relative group">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4">
                <h2 className="text-white ml-4 text-lg font-bold mb-2">
                  {product.name}
                </h2>
